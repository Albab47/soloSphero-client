...
const JobDetails = () => {
  ...
  const handlePlaceBid = async (e) => {
    ...
    if (user.email === buyer.email) {
      return toast.error("Buyer can not bid on his own job post");
    }
  ...
  return (
    <div className="my-8 flex flex-col md:flex-row justify-around gap-5  items-center min-h-[calc(100vh-306px)] md:max-w-screen-xl mx-auto ">
      {/* Job Details */}
